...
{  
    ...
    glm::mat4 lightView = glm::lookAt(ViewMatrix, 
                                    glm::vec3( VLightMatrix), 
                                    glm::vec3( 0.0f, 1.0f,  0.0f));  

    this->_lightSpaceMatrix = lightProjection * lightView; 

    glm::mat4 MVMatrix = glm::translate(glm::mat4(1), glm::vec3(model.getPosition()));
